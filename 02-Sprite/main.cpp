...
void LoadResources()
{
	...
	sprites->Add(20010, 149, 60, 170, 81, texEnemy);
	sprites->Add(20020, 169, 60, 189, 81, texEnemy);
	sprites->Add(20030, 189, 60, 210, 81, texEnemy);
	sprites->Add(20040, 209, 60, 230, 81, texEnemy);
	...
	*/
	...
	for(int i =0;i<3;i++)
	{
		enemies[i] = new CGameObject();
		enemies[i]->AddAnimation(400);
		enemies[i]->AddAnimation(401);
		enemies[i]->SetPosition(30.0f, 130.0f+50*i);
	}
